...
| File | What it is |
|---|---|
| [`Redshift-SOC-Project-Charter.docx`](./Redshift-SOC-Project-Charter.docx) | Pre-build project charter & technical design document — objectives, requirements, architecture decisions and rationale, risk assessment, phased roadmap |
| [`SOC-Home-Lab-Documentation.docx`](./SOC-Home-Lab-Documentation.docx) | Build log — Step 1 through Step 10, with real troubleshooting and root causes documented alongside the intended process |
| `Attack-Simulation-Report.docx` *(coming soon)* | Step 11 — MITRE ATT&CK-mapped attack simulations run against the environment, with the resulting Splunk telemetry for each |
...
- Publish the Attack Simulation Report (Step 11) and corresponding Splunk detection searches / dashboards
